...
\texttt{-line} & Tratar cadena como múltiples líneas (\^{} y \$ coinciden con inicio/fin de línea) \\
\texttt{-lineanchor} & Similar a -line \\
\texttt{-expanded} & Ignorar espacios en blanco en patrón (para legibilidad) \\
\bottomrule
\end{tabular}
\end{table}
