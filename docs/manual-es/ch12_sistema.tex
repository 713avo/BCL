...
\cmd{ENV} lee variables de entorno del sistema operativo. Si la variable de entorno solicitada no existe, ENV devuelve una cadena vacía (no un error).
...
\textbf{Valor de retorno:} El valor de la variable de entorno, o cadena vacía si no está configurada.
