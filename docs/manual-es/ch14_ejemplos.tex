% ============================================================================
% CAPÍTULO 14: EJEMPLOS
% ============================================================================

\chapter{Ejemplos}
\label{ch:examples}

\section{Procesador de Archivos de Texto}
...
\begin{examplebox}[title=Calculadora Interactiva]
\begin{lstlisting}[language=BCL]
...
\section{Gestor de Lista de Tareas}

\begin{examplebox}[title=Aplicación de Lista de Tareas]
\begin{lstlisting}[language=BCL]
SET todos [LIST]
...
\section{Analizador de Archivos de Log}

\begin{examplebox}[title=Analizar Logs]
\begin{lstlisting}[language=BCL]
